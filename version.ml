...
(*  $Id: version.ml,v 1.13 2004-10-28 13:51:38 doligez Exp $  *)
...
let date = "2004-10-28";;
let number = 14;;  (* This number must never decrease. *)
...
let version_list =
   ref ["$Id: version.ml,v 1.13 2004-10-28 13:51:38 doligez Exp $"]
;;
