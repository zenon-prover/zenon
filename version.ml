...
(*  $Id: version.ml,v 1.11 2004-10-15 20:54:46 doligez Exp $  *)
...
let date = "2004-10-15";;
let number = 11;;  (* This number must never decrease. *)
...
let version_list =
   ref ["$Id: version.ml,v 1.11 2004-10-15 20:54:46 doligez Exp $"]
;;
