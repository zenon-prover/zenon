...
(*  $Id: version.ml,v 1.8 2004-10-11 16:08:18 doligez Exp $  *)
...
let date = "2004-10-11";;
let number = 8;;  (* This number must never decrease. *)
...
let version_list =
   ref ["$Id: version.ml,v 1.8 2004-10-11 16:08:18 doligez Exp $"]
;;
