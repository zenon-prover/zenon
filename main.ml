...
Version.add "$Id: main.ml,v 1.41 2008-08-14 14:08:25 pessaux Exp $";;
...
let rec argspec = [
  ...
  "-focalize", Arg.Set used_for_focalize_flag,
           "           tell Zenon that the .zv file is generated by FoCaLize, and not by the old version of the compiler." ;
